...
class DevelopmentConfig(BaseConfig):
    ...
    SOCKETIO_MESSAGE_QUEUE = BaseConfig.SOCKETIO_MESSAGE_QUEUE
    CELERY_BROKER_URL = BaseConfig.CELERY_BROKER_URL
    CELERY_RESULT_BACKEND = BaseConfig.CELERY_RESULT_BACKEND
    RATELIMIT_STORAGE_URI = BaseConfig.RATELIMIT_STORAGE_URI or "memory://"
