...
ROOT_APP_MODULE_NAME = "bakery_root_app_customer"
...
APP_PORT = ROOT_APP_MODULE.PORTAL_PORTS["customer"]
config_name = (
    os.environ.get("FLASK_ENV", "development").strip().lower() or "development"
)
app = ROOT_APP_MODULE.create_app(config_name, portal_role="customer")
